...
const Footer = () => {
  const footerIcon = [
    { id: 1, icon: <img src="/assets/insta (2).svg" /> },
    { id: 2, icon: <img src="/assets/facebook (2).svg" /> },
    { id: 3, icon: <img src="/assets/whatapp (2).svg" /> },
    { id: 4, icon: <img src="/assets/linked (2).svg" /> },
    { id: 5, icon: <img src="/assets/pinterest.svg" /> },
  ];
        ...
        <div className="relative max-w-7xl mx-auto rounded-3xl py-5">
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-3 gap-14 text-white mt-24 px-4 md:px-5">
            ...
            <div className="relative flex flex-col items-center md:items-start">
              ...
              <p className="mt-6 md:absolute md:-left-20 md:top-20 
        ...
        <div className="border-t border-emerald-400/20 mt-10">
          ...
          >
            Brand Spark
             ...
             {/*  <span className="text-primary">Brand Spark</span> */}
            </span>
